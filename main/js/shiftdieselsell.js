$(function () {
    ...
    $('#submitsell').click(function (e){
        ...
        if(date===""|| time===""||manager===""||IsNumeric(prevStock)||IsNumeric(newStock)||IsNumeric(totalStock)||IsNumeric(sellQuantity)||IsNumeric(buyRate)||IsNumeric(sellRate)){
            ...
            //post diesel sells shift and diesel/diesel_sell.php
            request = $.ajax({
                url: "diesel/diesel_info.php",
                type: "post",
                data: serializedData,
    ...
    //for ajax datatable and get data from diesel/ajaxdieselshift.php;
