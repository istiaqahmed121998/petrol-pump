$(function () {
    ...
    $( "#edit_sell" ).click(function (e){
        ...
        var profitEdit=''+(parseInt(earnEdit)-parseInt(investmentEdit));
    ...
    $('#submitsell').click(function (e){
        ...
        if(date===""|| time===""||manager===""||IsNumeric(prevStock)||IsNumeric(newStock)||IsNumeric(totalStock)||IsNumeric(sellQuantity)||IsNumeric(buyRate)||IsNumeric(sellRate)){
            ...
            //post mobil sells shift and mobil/mobil_sell.php
            request = $.ajax({
                url: "mobil/mobil_info.php",
                type: "post",
                data: serializedData,
    ...
    //for ajax datatable and get data from mobil/ajaxmobilshift.php;
    var tablea=$('#sale').DataTable({
        ...
        footerCallback: function( tfoot, data, start, end, display ) {
            ...
            $(api.column(9).footer()).html(
                afterTwo(api.column(9).data().reduce(function ( a, b ) {
                    return intVal(a) + intVal(b);
            ...
            $(api.column(11).footer()).html(
                afterTwo(api.column(11).data().reduce(function ( a, b ) {
                    return intVal(a) + intVal(b);
                }, 0)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")+' ৳'

            );
            $(api.column(12).footer()).html(
                afterTwo(api.column(12).data().reduce(function ( a, b ) {
                    return intVal(a) + intVal(b);
                }, 0)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")+' ৳'
