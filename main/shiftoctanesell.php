                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h4 class="box-title">Selling Octane</h4>
                            </div>
                            <form method="post" id="sell_octane">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" name="new_stock" id="new_stock" placeholder="Add Stock" required="" data-validation-required-message="This field is required" min="0" aria-invalid="true">
...
<script src="js/shiftoctanesell.js"></script>
