...
$databasePassword="01712274429";
if($_SERVER['REQUEST_METHOD']==='POST'){
    $file=$_FILES["file"]["tmp_name"];
   // $q=file_get_contents();

    IMPORT_TABLES($databaseHost,$databaseUser,$databasePassword,$databaseName,$file);
}
function EXPORT_DATABASE($host,$user,$name,$pass,       $tables=false, $backup_name=false)
{
